...
import com.miguelrochefort.MODEL_HEIGHT
import com.miguelrochefort.MODEL_WIDTH
import com.miguelrochefort.REQUEST_CAMERA_PERMISSION
...
class PosenetActivity :
  ...
  private fun requestCameraPermission() {
    if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
      net.ingramintegrations.FitnessHelper.ConfirmationDialog()
  ...
  private var imageAvailableListener = object : OnImageAvailableListener {
    override fun onImageAvailable(imageReader: ImageReader) {
      ...
      net.ingramintegrations.FitnessHelper.ImageUtils.convertYUV420ToARGB8888(
        yuvBytes[0]!!,
        yuvBytes[1]!!,
        yuvBytes[2]!!,
        previewWidth,
