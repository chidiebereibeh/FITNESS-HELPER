...
import static net.ingramintegrations.FitnessHelper.BMICalcUtil.BMI_CATEGORY_HEALTHY;
import static net.ingramintegrations.FitnessHelper.BMICalcUtil.BMI_CATEGORY_OBESE;
import static net.ingramintegrations.FitnessHelper.BMICalcUtil.BMI_CATEGORY_OVERWEIGHT;
import static net.ingramintegrations.FitnessHelper.BMICalcUtil.BMI_CATEGORY_UNDERWEIGHT;
...
public class BMICalculatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(BMICalculatorActivity.this, "Populate Weight and Height to Calculate BMI", Toast.LENGTH_SHORT).show();
